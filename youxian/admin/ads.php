...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    /* 插入数据 */
    $sql = "INSERT INTO ".$ecs->table('ad'). " (position_id,media_type,ad_name,ad_link,ad_code,start_time,end_time,link_man,link_email,link_phone,click_count,enabled,ad_img_text,ad_text_color)
...
elseif ($_REQUEST['act'] == 'update')
{
    ...
    $sql = "UPDATE " .$ecs->table('ad'). " SET ".
            ...
            "ad_img_text = '$_POST[ad_img_text]', ".
            "ad_text_color = '$_POST[ad_text_color]' ".
            "WHERE ad_id = '$id'";
    $db->query($sql);
