    ...
    $_REQUEST['act'] != 'forget_pwd' && $_REQUEST['act'] != 'reset_pwd' && $_REQUEST['act'] != 'check_order')
{
    ...
    if (!empty($_SERVER['HTTP_REFERER']) && (
            ...
            strpos(preg_replace('/:\d+/', '', $_SERVER['HTTP_REFERER']), $_SERVER['SERVER_ADDR']) === false &&
            strpos(preg_replace('/:\d+/', '', $_SERVER['HTTP_REFERER']), 'wx.cnxunluo.cn') === false &&
            strpos(preg_replace('/:\d+/', '', $_SERVER['HTTP_REFERER']), 'm.cnxunluo.cn') === false
        )
    ) {
        if (!empty($_REQUEST['is_ajax']))
        {
