...
$modules['03_promotion']['coupon_manage']       = 'coupon.php?act=list';
$modules['03_promotion']['activity_clothes']       = 'yx_activity.php?act=list';
...
$modules['04_order']['order_pay_log']               = 'order_pay_log.php?act=list';
...
$modules['10_priv_admin']['cxs_list']             = 'privilege.php?act=list&role=cxs';
...
$modules['11_system']['10_shop_notify']             = 'shop_notify.php?act=list';
...
/*讯罗供应商管理*/
$modules['17_xl_gxy']['gys_list']                = 'agency.php?act=list';
$modules['17_xl_gxy']['gys_account']                   = 'privilege.php?act=list&role=gys';
//$modules['17_xl_gxy']['agency_list']                = 'agency.php?act=list';

$modules['18_gys_account']['gys_in_account']        = 'gys_account.php?act=in_list';
$modules['18_gys_account']['gys_out_account']        = 'gys_out_account.php?act=out_list';

//代付平台
$modules['19_sxy_manage']['sxy_in_account']        = 'sxy_manage.php?act=in_list';
$modules['19_sxy_manage']['sxy_out_account']        = 'sxy_manage_df.php?act=list';

//代理商管理
$modules['20_dls_manage']['dls_list'] = 'dls_manage.php?act=list';
$modules['20_dls_manage']['dls_ratio'] = 'dls_ratio.php?act=list';
//$modules['20_dls_manage']['dls_jiesuan'] = 'dls_manage.php?act=jiesuan';

$modules['cxs_manage']['cxs_account_manage']    = 'cxs_account.php?act=list';
$modules['cxs_manage']['cxs_earn_list']    = 'cxs_earn.php?act=list';
$modules['cxs_manage']['cxs_tixian_list']    = 'cxs_tixian.php?act=list';

$modules['recharge_card']['recharge_card_manage'] = 'recharge_card.php?act=list';
$modules['recharge_card']['recharge_card_log'] = 'recharge_card_log.php?act=list';
//游戏
$modules['yx_games']['yx_game_list'] = 'yxgames.php?act=list';
?>
