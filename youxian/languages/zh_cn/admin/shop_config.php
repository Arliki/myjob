...
$_LANG['cfg_name']['gys_price_rate'] = '供应商供货价格比例';
...
$_LANG['cfg_name']['custom'] = '自定义配置';
$_LANG['cfg_name']['dls_deposit'] = '代理商诚意金额';
$_LANG['cfg_name']['cxs_earn_from_dls'] = '承销商分成金额';

$_LANG['cfg_name']['show_sale_count'] = '是否显示销量';
$_LANG['cfg_range']['show_sale_count']['1'] = '显示';
$_LANG['cfg_range']['show_sale_count']['0'] = '不显示';
?>
