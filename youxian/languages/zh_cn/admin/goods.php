...
$_LANG['collage_size']='拼单规格：';
$_LANG['collage_time']='拼单有效期：';
$_LANG['collage_max']='拼单人数：';
$_LANG['collage_f_p']='拼单拼主价格：';
$_LANG['collage_o_p']='拼单他人价格：';

$_LANG['compute_by_mp'] = '按市场价计算';

$_LANG['notice_collage_size']='拼单发货的规格属性。';
$_LANG['notice_collage_time']='每单有效期，单位是小时，范围是6-72小时，只填数字即可。';
$_LANG['notice_collage_max']='拼单成功所需人数。';
$_LANG['notice_collage_f_p']='拼主所需支付，允许为0。';
$_LANG['notice_collage_o_p']='除拼主外他人所需支付，允许为0。';
