...
$_LANG['app_name'] = '讯罗优选';
$_LANG['cp_home'] = '讯罗优选 管理中心';
$_LANG['copyright'] = '版权所有 &copy; 2017 洛阳讯罗技术有限公司';
...
$_LANG['17_xl_gxy'] = '供应商管理';
$_LANG['18_gys_account'] = '供应商资金管理';
$_LANG['gys_in_account'] = '入账明细';
$_LANG['gys_out_account'] = '提现记录';
$_LANG['gys_out_account_check'] = '提现申请审核打款';
$_LANG['check_gys_shipping_and_pay_first'] = '审核物流单号并结算首期款';
$_LANG['order_export'] = '订单导出';
$_LANG['assign_order_agency'] = '手动指派订单供应商';
$_LANG['coupon_manage'] = '优惠券管理';
$_LANG['activity_clothes'] = '集赞转发活动';
$_LANG['order_pay_log'] = '订单支付记录';

$_LANG['19_sxy_manage'] = '代付平台管理';
$_LANG['sxy_in_account'] = '充值记录';
$_LANG['sxy_out_account'] = '打款记录';
$_LANG['sxy_add_account'] = '代付余额充值';
$_LANG['fix_gys_account'] = '调节供应商资金账户';

$_LANG['20_dls_manage'] = '代理商管理';
$_LANG['dls_list'] = '代理商列表';
$_LANG['dls_add'] = '添加代理商';
$_LANG['dls_edit'] = '编辑代理商';
$_LANG['dls_ratio'] = '提成设置';
$_LANG['dls_jiesuan'] = '代理商结算';
$_LANG['dls_jjr'] = '经纪人列表';
$_LANG['export_dls'] = '导出代理商';
$_LANG['check_and_pay_user_tixian'] = '审核用户提现并打款';

$_LANG['cxs_manage'] = '承销商管理';
$_LANG['cxs_account_manage'] = '承销商账户';
$_LANG['cxs_earn_list'] = '收入明细';
$_LANG['cxs_tixian_list'] = '提现明细';
$_LANG['cxs_tixian'] = '申请提现';

$_LANG['recharge_card'] = '充值卡管理';
$_LANG['recharge_card_list'] = '充值卡';
$_LANG['recharge_card_log'] = '使用记录';

$_LANG['recharge_card_list'] = '充值卡管理';
$_LANG['recharge_card_manage'] = '充值卡管理';
$_LANG['create_recharge_card'] = '生成卡密';
$_LANG['export_recharge_cards'] = '导出卡密';
$_LANG['recharge_card_log'] = '充值卡使用记录';
...
/* 促销管理 */
$_LANG['02_snatch_list'] = '限时抢购';
$_LANG['snatch_add'] = '添加抢购商品';
...
$_LANG['agency_list'] = '供应商列表';
$_LANG['suppliers_list'] = '供货商列表';
$_LANG['gys_list'] = '供应商列表';
$_LANG['gys_account'] = '供应商账户';
$_LANG['cxs_list'] = '承销商列表';
/* 系统设置 */
...
$_LANG['10_shop_notify'] = '商城通知管理';
$_LANG['shop_notify_list'] = '通知列表';
$_LANG['shop_notify_new'] = '新增列表';
...
$_LANG['yx_games'] = '游戏管理';
$_LANG['yx_game_list'] = '游戏管理';
$_LANG['yx_game_manage'] = '游戏管理';
