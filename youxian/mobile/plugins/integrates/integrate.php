...
class integrate
{
    ...
    function edit_user($cfg)
    {
        ...
        if (!empty($cfg['bank_account'])) {
            $values[] = "bank_account='" . $cfg['bank_account'] . "'";
        }
        if (!empty($cfg['bank_account_name'])) {
            $values[] = "bank_account_name='" . $cfg['bank_account_name'] . "'";
        }
        if (!empty($cfg['bank_name'])) {
            $values[] = "bank_name='" . $cfg['bank_name'] . "'";
        }
        if (!empty($cfg['bank_province'])) {
            $values[] = "bank_province='" . $cfg['bank_province'] . "'";
        }
        if (!empty($cfg['bank_city'])) {
            $values[] = "bank_city='" . $cfg['bank_city'] . "'";
        }
        if (!empty($cfg['bank_code'])) {
            $values[] = "bank_code='" . $cfg['bank_code'] . "'";
        }
