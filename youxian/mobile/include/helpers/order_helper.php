...
//function get_gys_by_order_id($order_id){
//    $global = getInstance();
//    $agency_id = $global->db->getOne("SELECT agency_id FROM ".$global->ecs->table('order_info')." WHERE order_id='".$order_id."'");
//    return $global->db->getRow("SELECT * FROM ".$global->ecs->table('agency')." WHERE agency_id='".$agency_id."'");
//}
