...
class WechatController extends AdminController
{
    ...
    */
    ...
    public function share_list()
    {
        ...
        ->limit($offset)
        ->select();
        //TODO 根据不同场景，计算推广成交量（代理商,经纪人,用户推广）
//        if($list){
//            foreach($list as $key=>$val){
//                $list[$key]['share_account'] = $this->model->table('affiliate_log')->field('sum(money)')->where('separate_type = 0 and user_id = '.intval($val['scene_id']))->getOne();
//            }
//        }
