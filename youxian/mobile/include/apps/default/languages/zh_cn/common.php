...
$_LANG['exchange_sort']['exchange_integral'] = '按果豆排序';
...
$_LANG['lack_pay_points'] = '你果豆不够，不能出价';
$_LANG['snatch'] = '夺宝奇兵';
...
$_LANG['use_integral'] = '使用果豆';
$_LANG['can_use_integral'] = '您当前的可用果豆为';
...
$_LANG['self_site'] = '本站';
$_LANG['order_gift_integral'] = '订单 %s 赠送的果豆';
...
$_LANG['bingo_pay'] = '您已成功参与本次抽奖。';
$_LANG['bingo_err'] = '您已参与过本次抽奖。';
$_LANG['bingo_al'] = '若非本人操作,请及时与我们取得联系。';
...
$_LANG['log_action']['exchange_goods'] = '果豆可兑换的商品';
...
$_LANG['integral_not_enough'] = '您使用的果豆不能超过您现有的果豆。';
$_LANG['integral_too_much'] = "您使用的果豆不能超过%d";
