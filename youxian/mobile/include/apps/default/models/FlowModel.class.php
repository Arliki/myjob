...
class FlowModel extends BaseModel {
    ...
    function exchange_goods_need_point($goods_id){
        $sql = "SELECT exchange_integral FROM ".$this->pre."exchange_goods WHERE goods_id='$goods_id'";
        $res = $this->row($sql);
        return $res['exchange_integral'];
    }
    // 增加销量统计
